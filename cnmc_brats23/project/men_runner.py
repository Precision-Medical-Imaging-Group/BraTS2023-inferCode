...
from ensembler.ensemble import men_ensembler
...
def infer_single(input_path, out_dir):
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        nnunet_npz_path_list = run_infer_nnunet(input_folder_raw/ name, maybe_make_dir(temp_dir/ 'nnunet'), 'BraTS2023_MEN', name, ensemble=False)
        ...
        ensembled_pred_nii_path = men_ensembler(nnunet_npz_path_list, swinunetr_npz_path_list, ensemble_folder, one_image)
